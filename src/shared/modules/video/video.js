...
const videoFrame = function(el, app) {
    ...
    const setButtonTransition = function() {
        ...
        const transformX = ( posterWidth - playEndWidth ) - ( (posterWidth/2) - (playWidth/2) ) - playEndWidth - 12;
        const transformY = ( posterHeight - playEndWidth ) - ( (posterHeight/2) - (playWidth/2) ) - playEndWidth - 12;
